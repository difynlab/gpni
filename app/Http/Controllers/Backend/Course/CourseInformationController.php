...
class CourseInformationController extends Controller
{
    ...
    public function update(Request $request, Course $course)
    {
        $validator = Validator::make($request->all(), [
            ...
            'new_master_section_7_video' => 'nullable|max:102400',
            'master_section_8_video_files.*' => 'nullable|max:102400',
        ], [
            ...
            'new_master_section_7_video.max' => 'Video must not be greater than 100 MB',
            'master_section_8_video_files.*.max' => 'Each video must not be greater than 100 MB',
        ]);
