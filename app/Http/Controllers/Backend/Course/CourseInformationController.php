...
class CourseInformationController extends Controller
{
    ...
    public function update(Request $request, Course $course)
    {
        $validator = Validator::make($request->all(), [
            ...
            'new_certification_section_4_video' => 'nullable|max:409600',
            'certification_section_6_team_files.*' => 'nullable|max:30720',
            'new_certification_section_7_video' => 'nullable|max:409600',
            ...
            'new_certification_section_14_video' => 'nullable|max:409600',
            'new_certification_section_15_video' => 'nullable|max:409600',

            'new_master_section_4_image' => 'nullable|max:30720',
            'new_master_section_7_video' => 'nullable|max:409600',
            'master_section_8_video_files.*' => 'nullable|max:409600',
        ], [
            ...
            'new_certification_section_4_video.max' => 'Video must not be greater than 400 MB',
            'certification_section_6_team_files.*.max' => 'Each image must not be greater than 30 MB',
            'new_certification_section_7_video.max' => 'Video must not be greater than 400 MB',
            ...
            'new_certification_section_10_image.max' => 'Image must not be greater than 30 MB',
            'new_certification_section_14_video.max' => 'Video must not be greater than 400 MB',
            'new_certification_section_15_video.max' => 'Video must not be greater than 400 MB',

            'new_master_section_4_image.max' => 'Image must not be greater than 30 MB',
            'new_master_section_7_video.max' => 'Video must not be greater than 400 MB',
            'master_section_8_video_files.*.max' => 'Each video must not be greater than 400 MB',
        ]);
