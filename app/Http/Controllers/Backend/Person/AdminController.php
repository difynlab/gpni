...
class AdminController extends Controller
{
    private function processAdmins($admins)
    {
        foreach($admins as $admin) {
            ...
            $admin->image = $admin->image != null ? '<img src="'. asset('storage/backend/persons/admins/' . $admin->image) .'" class="table-image">' : '<img src="'. asset('storage/common/' . Setting::find(1)->no_image) .'" class="table-image">';
