...
class StudentController extends Controller
{
    private function processStudents($students)
    {
        foreach($students as $student) {
            ...
            $student->image = $student->image != null ? '<img src="'. asset('storage/backend/persons/students/' . $student->image) .'" class="table-image">' : '<img src="'. asset('storage/backend/no-image.jpg') .'" class="table-image">';
