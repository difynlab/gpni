    ...
    <div class="container py-4 py-lg-5 px-3 px-md-0">
        <div class="row gy-4 mb-3">
            <div class="col-12 col-md-4">
                <a href="{{ $contents->{'footer_powered_link_' . $middleware_language} ?? $contents->footer_powered_link_en }}" class="d-inline-block mb-3">
                ...
                <div class="d-flex flex-column">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            <a href="{{ $common->footer_podcast_link }}" target="_blank">{{ $contents->{'footer_podcast_' . $middleware_language} ?? $contents->footer_podcast_en }}</a>
                        </li>
                        <li>
                            @php
