...
@section('title', 'Create Course Module Exam Question')

@section('content')

    <x-backend.breadcrumb page_name="Create Course Module Exam Question"></x-backend.breadcrumb>

    <div class="static-pages">
        <form action="{{ route('backend.courses.module-exam-questions.store', $course_module) }}" method="POST" enctype="multipart/form-data">
            @csrf
