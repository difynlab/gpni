...
<x-backend.notification></x-backend.notification>
    ...
    <div class="table-container">
        <x-backend.breadcrumb page_name="Users" button_title="User" create=true></x-backend.breadcrumb>

        <form action="{{ route('backend.users.filter') }}" method="POST" class="filter-form">
            @csrf
                        ...
                        <form action="{{ route('backend.users.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input class="form-control phone" type="text" name="phone" value="{{ old('phone') }}" required>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <x-backend.input-error field="profile_image"></x-backend.input-error>
                                </div>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input class="form-control phone" type="text" name="phone" readonly>
                                </div>
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="form-label">Email<span class="asterisk">*</span></label>
                                    <input class="form-control email" type="email" name="email" value="{{ old('email') }}" required>
                                    <x-backend.input-error field="email"></x-backend.input-error>                                </div>

                                <div class="col-12 mb-3">
                                    <label class="form-label">Phone<span class="asterisk">*</span></label>
                                    <input class="form-control phone" type="text" name="phone" value="{{ old('phone') }}" required>
                                    <x-backend.input-error field="phone"></x-backend.input-error>                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <x-backend.input-error field="new_profile_image"></x-backend.input-error>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="submit" class="btn form-btn close-btn" data-bs-dismiss="modal" title="Cancel">Cancel</button>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data['profile_image'] != null) {
                            $('.view-modal .old_profile_image_div').attr('src', "{{ url('/storage/profile_images') }}/" + data['profile_image']);
                        }
                        else {
                            $('.view-modal .old_profile_image_div').attr('src', "{{ url('/storage/no-image.jpg') }}");
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data['profile_image'] != null) {
                            ...
                            $('.edit-modal .old_profile_image_div').attr('src', "{{ url('/storage/profile_images') }}/" + data['profile_image']);
                        }
                        else {
                            $('.edit-modal .old_profile_image').val();
                            $('.edit-modal .old_profile_image_div').attr('src', "{{ url('/storage/no-image.jpg') }}");
                        }
