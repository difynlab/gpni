                    ...
                    <div class="col-8">
                        <div class="chat-box">
                            <div class="single-message user-single-message mb-3">
                                ...
                                @else
                                    <img src="{{ asset('storage/common/' . App\Models\Setting::find(1)->no_profile_image) }}" class="user-profile-image" alt="Profile Image">
                                @endif
                            ...
                            @foreach($ask_question_replies as $ask_question_reply)
                                ...
                                @else
                                    <div class="single-message admin-single-message mb-3">
                                        ...
                                        @else
                                            <img src="{{ asset('storage/common/' . App\Models\Setting::find(1)->no_profile_image) }}" class="admin-profile-image" alt="Profile Image">
                                        @endif
                                    </div>
                                @endif
                            @endforeach
