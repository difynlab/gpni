            ...
            <div class="section">
                ...
                <div class="row form-input">
                    <div class="col-4 mb-4">
                        <label for="search_placeholder_{{ $short_code }}" class="form-label">Search Placeholder</label>
                        <input type="text" class="form-control" id="search_placeholder_{{ $short_code }}" name="search_placeholder_{{ $short_code }}" value="{{ $contents->{'search_placeholder_' . $short_code} ?? '' }}" placeholder="Search Placeholder">
                    </div>

                    <div class="col-4 mb-4">
                        <label for="search_button_{{ $short_code }}" class="form-label">Search Button</label>
                        <input type="text" class="form-control" id="search_button_{{ $short_code }}" name="search_button_{{ $short_code }}" value="{{ $contents->{'search_button_' . $short_code} ?? '' }}" placeholder="Search Button">
                    </div>
                    ...
                    <div class="col-4">
                        <label for="no_nutritionists_{{ $short_code }}" class="form-label">No Nutritionists</label>
                        <input type="text" class="form-control" id="no_nutritionists_{{ $short_code }}" name="no_nutritionists_{{ $short_code }}" value="{{ $contents->{'no_nutritionists_' . $short_code} ?? '' }}" placeholder="No Nutritionists">
                    </div>
                </div>
            </div>

            <div class="section">
                <p class="inner-page-title">Search Links</p>

                <div class="row form-input">
                    <div class="col-3">
                        <label class="form-label">Button Label</label>

                        <input type="text" class="form-control mb-3" name="search_button_labels[]" placeholder="Label" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[0]->label ?? '' }}">

                        <input type="text" class="form-control mb-3" name="search_button_labels[]" placeholder="Label" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[1]->label ?? '' }}">

                        <input type="text" class="form-control mb-3" name="search_button_labels[]" placeholder="Label" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[2]->label ?? '' }}">

                        <input type="text" class="form-control" name="search_button_labels[]" placeholder="Label" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[3]->label ?? '' }}">
                    </div>

                    <div class="col-9">
                        <label class="form-label">Link</label>

                        <input type="url" class="form-control mb-3" name="search_button_links[]" placeholder="Link" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[0]->link ?? '' }}">

                        <input type="url" class="form-control mb-3" name="search_button_links[]" placeholder="Link" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[1]->link ?? '' }}">

                        <input type="url" class="form-control mb-3" name="search_button_links[]" placeholder="Link" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[2]->link ?? '' }}">

                        <input type="url" class="form-control" name="search_button_links[]" placeholder="Link" value="{{ json_decode($contents->{'search_labels_links_' . $short_code})[3]->link ?? '' }}">
                    </div>
                </div>
            </div>
