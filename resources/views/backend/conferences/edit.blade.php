            ...
            <div class="section">
                ...
                <div class="row form-input">
                    ...
                    <div class="col-6 mb-4">
                        ...
                        <input type="date" class="form-control" id="early_registration_deadline" name="early_registration_deadline" value="{{ old('early_registration_deadline', $conference->early_registration_deadline) }}" placeholder="Early Registration Deadline">
                    </div>
    ...
    <script>
        ...
        $('.add-more-details-button').on('click', function() {
            let html = `<div class="row single-item mt-3">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" name="more_detail_values[]" placeholder="Value" required>
                            </div>
                            <div class="col-1 d-flex align-items-center">
                                <a class="delete-button" title="Delete"><i class="bi bi-trash3"></i></a>
                            </div>
