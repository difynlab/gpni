...
@section('content')
    ...
    <x-backend.breadcrumb page_name="Create Coupon"></x-backend.breadcrumb>
                ...
                <div class="row form-input">
                    ...
                    <div class="col-6 mb-4">
                        ...
                        <select class="form-control form-select" name="coupon_for" id="coupon_for" required>
                            ...
                            <option value="Course Purchase" {{ old('type') == 'Course Purchase' ? 'selected' : '' }}>Course Purchase</option>
                            <option value="Membership Purchase" {{ old('type') == 'Membership Purchase' ? 'selected' : '' }}>Membership Purchase</option>
                            <option value="Product Purchase" {{ old('type') == 'Product Purchase' ? 'selected' : '' }}>Product Purchase</option>
                            <option value="Already Purchased Course" {{ old('type') == 'Already Purchased Course' ? 'selected' : '' }}>Already Purchased Course</option>
                        </select>
                    ...
                    <div class="col-6 mb-4">
                        ...
                        <select class="form-control form-select" name="coupon_validity" id="coupon_validity" required>
                            ...
                            <option value="Fix Time" {{ old('coupon_validity') == 'Fix Time' ? 'selected' : '' }}>Fix Time</option>
                            <option value="Life Time" {{ old('coupon_validity') == 'Life Time' ? 'selected' : '' }}>Life Time</option>
                        </select>
                        <x-backend.input-error field="coupon_validity"></x-backend.input-error>
                    </div>

                    @if(old('coupon_for') == 'Already Purchased Course')
                    ...
                    @if(old('coupon_validity') == 'Fix Time')
                        ...
                        <div class="col-6 mb-4 fix-time-fields">
                            ...
                            <input type="time" class="form-control" id="expiry_time" name="expiry_time" value="{{ old('expiry_time') }}" placeholder="Expiry Time">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="value" name="value" value="{{ old('value') }}" placeholder="Amount/ Percentage" required>
