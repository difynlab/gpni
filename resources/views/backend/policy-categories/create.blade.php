...
@section('title', 'Create Policy Category')

@section('content')

    <x-backend.breadcrumb page_name="Create Policy Category"></x-backend.breadcrumb>

    <div class="static-pages">
        <form action="{{ route('backend.policy-categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
