...
@section('content')
    ...
    <div class="static-pages">
        <form action="{{ route('backend.purchases.product-purchases.refund-status', $product_purchase->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="section">
                ...
                <div class="row form-input">
                    <div class="col-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" value="{{ $product_purchase->time }}" readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input class="form-control" value="{{ $product_purchase->transaction_id }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" value="{{ $product_purchase->discount_applied }}" readonly>
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Payment Status</label>
                            <input class="form-control" value="{{ $product_purchase->payment_status }}" readonly>
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Receipt URL</label>
                            <input class="form-control" value="{{ $product_purchase->receipt_url }}" readonly>
                        </div>
                        ...
                        <div style="background: #fffbea; border: 1px solid #f0c040; border-radius: 8px; padding: 12px;">
                            ...
                            <select class="form-control" name="refund_status">
                                <option value="Not Refunded" {{ $product_purchase->refund_status != 'Refunded' ? 'selected' : '' }}>Not Refunded</option>
                                <option value="Refunded" {{ $product_purchase->refund_status == 'Refunded' ? 'selected' : '' }}>Refunded</option>
                            </select>
                        </div>
                    </div>
                </div>
