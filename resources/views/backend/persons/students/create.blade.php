...
@section('content')
    ...
    <x-backend.breadcrumb page_name="Create Student"></x-backend.breadcrumb>

    <div class="static-pages">
        <form action="{{ route('backend.persons.students.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="section">
                <p class="inner-page-title">Student Details</span></p>
                ...
                <div class="row form-input">
                    ...
                    <div class="col-12">
                        <x-backend.upload-image old_name="old_image" old_value="{{ old('image') }}" new_name="new_image" path="persons/students" label="Student"></x-backend.upload-image>
