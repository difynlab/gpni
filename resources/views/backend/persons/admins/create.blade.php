...
@section('content')
    ...
    <x-backend.breadcrumb page_name="Create Admin"></x-backend.breadcrumb>

    <div class="static-pages">
        <form action="{{ route('backend.persons.admins.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="section">
                ...
                <div class="row form-input">
                    ...
                    <div class="col-12">
                        <x-backend.upload-image old_name="old_image" old_value="{{ old('image') }}" new_name="new_image" path="persons/admins" label="Admin"></x-backend.upload-image>
