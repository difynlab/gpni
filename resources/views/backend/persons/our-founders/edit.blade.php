        ...
        <form action="{{ route('backend.persons.our-founders.update', $our_founder) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="section">
                ...
                <div class="row form-input">
                    ...
                    <div class="col-12">
                        <x-backend.upload-image-must old_name="old_image" old_value="{{ $our_founder->image ?? old('image') }}" new_name="new_image" path="persons/our-founders"></x-backend.upload-image-must>
