        ...
        <form action="{{ route('backend.persons.issn-partners.update', $issn_partner) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="section">
                ...
                <div class="row form-input">
                    ...
                    <div class="col-12">
                        <x-backend.upload-image-must old_name="old_image" old_value="{{ $issn_partner->image ?? old('image') }}" new_name="new_image" path="persons/issn-partners"></x-backend.upload-image-must>
