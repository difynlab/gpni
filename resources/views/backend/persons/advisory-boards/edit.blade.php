        ...
        <form action="{{ route('backend.persons.advisory-boards.update', $advisory_board) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="section">
                ...
                <div class="row form-input">
                    ...
                    <div class="col-12">
                        <x-backend.upload-image old_name="old_image" old_value="{{ $advisory_board->image ?? old('image') }}" new_name="new_image" path="persons/advisory_boards"></x-backend.upload-image>
