            ...
            <div class="container-main">
                ...
                <nav class="mb-3">
                    <ul class="tabs nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'All' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'All']) }}">All</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'Image' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'Image']) }}">Image</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'Video' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'Video']) }}">Video</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'Vimeo Video Link' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'Vimeo Video Link']) }}">Vimeo Video Link</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'PDF' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'PDF']) }}">PDF</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'Word' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'Word']) }}">Word</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'Excel' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'Excel']) }}">Excel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'PPT' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'PPT']) }}">PPT</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $filterType == 'Audio' ? 'active' : '' }}" href="{{ route('frontend.my-storage', ['type' => 'Audio']) }}">Audio</a>
                        </li>
