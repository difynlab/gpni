        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    ...
                    <button class="btn confirm-button start-exam-button mx-3">{{ $student_dashboard_contents->courses_exam_start_modal_start_module_exam }}</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="remaining-questions mt-5 mt-lg-0">
                                ...
                                <button class="finish-exam-btn" data-bs-toggle="modal" data-bs-target="#submit-modal">{{ $student_dashboard_contents->courses_exam_finish_module_exam }}</button>
                            </div>
                        </div>
                    </div>
                </div>
