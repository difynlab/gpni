                ...
                <div class="image-placeholder">
                    @if ($contents->{'section_1_video_' . $middleware_language})
                        <video
                            ...
                            autoplay muted loop playsinline controls class="w-100"></video>
                    @elseif($contents->section_1_video_en)
                        <video src="{{ asset('storage/backend/pages/' . $contents->section_1_video_en ?? '') }}" autoplay muted loop playsinline controls class="w-100"></video>
                    @else
