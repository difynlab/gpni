                    ...
                    <div class="row d-flex align-items-end">
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <div class="icon-item text-center">
                                <a href="mailto:{{ $settings->{'email_' . $middleware_language} ?? $settings->email_en }}" class="text-decoration-none">
                        ...
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <div class="icon-item text-center">
                                <a href="{{ $settings->{'instagram_' . $middleware_language} ?? $settings->instagram_en }}" class="text-decoration-none" target="_blank">
                        ...
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <div class="icon-item text-center">
                                <a href="{{ $settings->{'twitter_' . $middleware_language} ?? $settings->twitter_en }}" class="text-decoration-none" target="_blank">
                        ...
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <div class="icon-item text-center">
                                <a href="{{ $settings->{'linkedin_' . $middleware_language} ?? $settings->linkedin_en }}" class="text-decoration-none" target="_blank">
                        ...
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <div class="icon-item text-center">
                                <a href="{{ $settings->{'youtube_' . $middleware_language} ?? $settings->youtube_en }}" class="text-decoration-none" target="_blank">
                        ...
                        <div class="col-6 col-md-4 col-lg-2 mb-3">
                            <div class="icon-item text-center">
                                <a href="{{ $settings->{'fb_' . $middleware_language} ?? $settings->fb_en }}" class="text-decoration-none" target="_blank">
