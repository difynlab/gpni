                                    ...
                                    <div class="col-md-4 col-sm-6 col-12 mb-4">
                                        <div class="card h-100 d-flex flex-column mx-1">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <p class="card-text fs-16">{{ \Illuminate\Support\Str::words($all_course->short_description, 6, '...') }}<a href="{{ route('frontend.master-classes.show', $all_course) }}" class="learn-more">{{ $contents->{'section_2_learn_' . $middleware_language} ?? $contents->section_2_learn_en }}</a></p>
