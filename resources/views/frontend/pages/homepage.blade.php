...
@section('content')
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <div class="mb-4 mt-5 ff-poppins-medium fs-25 international-society-of-sport">{!! $contents->{'section_1_description_' . $language} ?? '' !!}</div>

                            <div class="pt-5">
                                <a href="{{ json_decode($contents->{'section_1_labels_links_' . $language})[0]->link ?? '' }}" class="fs-20 btn btn-primary py-sm-3 px-sm-5 me-3">{{ json_decode($contents->{'section_1_labels_links_' . $language})[0]->label ?? '' }}</a>

                                <a href="{{ json_decode($contents->{'section_1_labels_links_' . $language})[1]->link ?? '' }}" class="py-sm-3 px-sm-5 fs-20 fw-semi-bold learn-more">
                                    {{ json_decode($contents->{'section_1_labels_links_' . $language})[1]->label ?? '' }}
    ...
    <div class="container-xxl">
        <div class="container">
            <div class="text-center ">
                <h1 class="mb-3 mb-md-5 ff-poppins-medium fs-49">{{ $contents->{'section_2_title_' . $language} ?? '' }}</h1>
            </div>
    ...
    <div class="py-5">
        <div class="container pt-4 mt-4">
            <div class="text-center">
                <h1 class="mb-3 ff-poppins-medium fs-49">{{ $contents->{'section_3_title_' . $language} ?? '' }}</h1>
                <p class="mb-1 professional-body ff-poppins-regular fs-25">{{ $contents->{'section_3_description_' . $language} ?? '' }}</p>
            </div>
            ...
            <div class="text-center mt-5 pt-5">
                <a href="#" class="py-sm-4 px-sm-5 ff-poppins-medium fs-20 explore-course-text">Explore Courses<img src="{{ asset('storage/frontend/arrow-right.svg') }}"/></a>
            </div>
        </div>
    </div>
    <!-- One div dynamic is pending -->
