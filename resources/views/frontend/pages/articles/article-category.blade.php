...
@section('title', $article_category->name)
...
@section('content')
    ...
    <div class="container pt-5">
        ...
        <div class="all-articles-heading heading">{{ $article_category->name }}</div>
            ...
            <div class="col-xl-4 col-lg-5 ps-md-4 px-3">
                <div class="trending-articles-section articles-categories-section mb-4">
                    ...
                    @if(isset($article_categories) && $article_categories->isNotEmpty())
                        @foreach($article_categories as $sidebar_category)
                            <a href="{{ route('frontend.articles.category', [$sidebar_category, \Overtrue\Pinyin\Pinyin::permalink($sidebar_category->name)]) }}"
                                class="text-decoration-none d-block py-1">
                                <div class="trending-content-title line-clamp-1 mb-0">{{ $sidebar_category->name }}</div>
                            </a>
                        @endforeach
                    @endif
                </div>
