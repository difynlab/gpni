        ...
        <div class="row flex-grow-1 d-flex align-items-center">
            ...
            <div class="col-lg-8 white-section" style="min-height: 500px;">
                <div class="form-container">
                    ...
                    <div class="subheading">Log in with your data that you entered during your registration</div>
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="username" placeholder="john@gmail.com">
                        </div>
                        <div class="form-group">
                            <label for="password" style="font-size:16px; font-weight:500;">Password</label>
                            <div class="input-group position-relative">
                                <input type="password" class="form-control pr-5" id="password" placeholder="********">
                        ...
                        <button type="submit" class="btn btn-primary btn-block"
                            style="background-color: #0040c3; color: #fff; border: none; border-radius: 10px; height: 46px;">Login</button>
                    </form>
                </div>
            </div>
        </div>
