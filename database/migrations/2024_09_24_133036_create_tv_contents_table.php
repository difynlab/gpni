...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tv_contents', function (Blueprint $table) {
            ...
            $table->text('section_1_price_en')->nullable();
            ...
            $table->text('section_8_label_en')->nullable();
            ...
            $table->text('section_1_price_zh')->nullable();
            ...
            $table->text('section_8_label_zh')->nullable();
            ...
            $table->text('section_1_price_ja')->nullable();
            ...
            $table->text('section_8_label_ja')->nullable();
